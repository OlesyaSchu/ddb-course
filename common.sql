...
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4752992885','Кузнецова','Алиса','Ивановна','Ж','Россия, г. Ангарск, Цветочная ул., д. 12 кв.104', '1998-02-20','79156133385','zahar26071979@gmail.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4893947169','Калачева','Таисия','Ильинична','Ж','Россия, г. Орёл, Первомайская ул., д. 14 кв.98', '1975-11-10','79341575150','varvara54@rambler.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4441672082','Виноградов','Платон','Александрович','М','Россия, г. Севастополь, Колхозная ул., д. 6 кв.164', '1986-04-02','79129121615','viktoriya56@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4767437616','Сидорова','Алиса','Николаевна','Ж','Россия, г. Владивосток, Садовая ул., д. 11 кв.13', '2000-09-15','79821050774','konstantin1975@hotmail.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4322918289','Александров','Артур','Степанович','М','Россия, г. Бердск, Заслонова ул., д. 16 кв.212', '1976-07-30','79309833490','anjela5159@yandex.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4292705552','Крылов','Дмитрий','Миронович','М','Россия, г. Стерлитамак, Севернаяул., д. 22 кв.108', '1974-02-05','79872306123','german1962@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4183717871','Игнатьева','Арина','Кирилловна','Ж','Россия, г. Дербент, Дружбы ул., д. 9 кв.26', '1973-03-01','79935655379','maryamna15081989@yandex.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4894488064','Козлова','Аиша','Кирилловна','Ж','Россия, г. Салават, Радужная ул., д. 4 кв.194', '1974-12-24','79945072146','lidiya13@ya.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4291704310','Крючков','Марсель','Ибрагимович','М','Россия, г. Новочеркасск, Шоссейная ул., д. 22 кв.198','1980-12-31','79669498015','lyudmila6870@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4486663144','Васильева','Ева','Сергеевна','Ж','Россия, г. Волжский, Советский пер., д. 6 кв.19', '1987-10-04','79342218870','ignat.tarasov@hotmail.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4457987182','Абрамов','Демид','Саввич','М','Россия, г. Барнаул, Красноармейская ул., д. 25 кв.27', '1981-07-04','79282786234','anton28071973@mail.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4989158930','Калугин','Кирилл','Вадимович','М','Россия, г. Орёл, Коммунистическая ул., д. 22 кв.156', '1979-01-20','79052720898','oksana21@rambler.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4985239341','Агеев','Иван','Вадимович','М','Россия, г. Раменское, Интернациональная ул., д. 23 кв.116', '1976-09-07','79858044513','olga.yamatina@gmail.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4182650931','Кондратова','София','Никитична','Ж','Россия, г. Череповец, Мирная ул., д. 10 кв.23', '1996-02-02','79500093494','alena7552@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4360938606','Маркин','Никита','Тигранович','М','Россия, г. Липецк, Новоселов ул., д. 11 кв.6', '1976-01-25','79542408728','mila58@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4163548665','Тихонов','Николай','Георгиевич','М','Россия, г. Муром, Мира ул., д. 25 кв.20', '1980-08-13','79895877817','afanasiy1978@yandex.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4251934197','Андреев','Артём','Анатольевич','М','Россия, г. Сызрань, Центральная ул., д. 17 кв.87', '1979-05-06','79881844208','ivan4129@hotmail.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4626705650','Кузнецова','Виктория','Константиновна','Ж','Россия, г. Каменск - Уральский, Космонавтов ул., д. 17 кв.159', '1979-07-01','79616759774','apollinariya17091962@yandex.ru');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4093544095','Комарова','Амина','Саввична','Ж','Россия, г. Пятигорск, Первомайская ул., д. 14 кв.11', '1978-03-22','79829966140','ekaterina69@outlook.com');
INSERT INTO GUESTS VALUES (gen_random_uuid(),'4855971200','Спиридонова','Кристина','Григорьевна','Ж','Россия, г. Вологда, Якуба Коласа ул., д. 8 кв.39', '1970-09-10','79817629910','maryana20081970@outlook.com');
...
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Восьмиместный', 750.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Шестиместный', 800.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Четырехместный', 900.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Трехместный', 2500.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Двухместный', 4400.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Одноместный', 4800.00);
INSERT INTO PLACE_TYPE VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'Апартаменты', 5300.00);

INSERT INTO BOOKING_STATUS VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'A', 'Бронь');
INSERT INTO BOOKING_STATUS VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'B', 'Оплачено');
INSERT INTO BOOKING_STATUS VALUES (uuid_in(md5(random()::text || random()::text)::cstring), 'C', 'Отмена');
...
AS $$
  ...
  BEGIN
    ...
    LOOP
      ...
      WHILE EXISTS (select * from BOOKINGS where 
      ...
      _place_id = (select PLACE_ID from PLACES order by random() limit 1);
      amount = days_in_book * (select PRICE from PLACES as p left join PLACE_TYPE as pt on p.PLACE_TYPE_ID = pt.PLACE_TYPE_ID where p.PLACE_ID = _place_id);
      insert into BOOKINGS values (gen_random_uuid(), ar_date, ar_date + days_in_book,
      amount, (select BK_ID from BOOKING_STATUS order by random() limit 1),
      (select GUEST_ID from GUESTS order by random() limit 1),
      _place_id
      );
    END LOOP;
  END;
    ...
    LOOP
      ...
      LOOP
        insert into PLACES values 
          (gen_random_uuid(), (select PLACE_TYPE_ID from PLACE_TYPE order by random() limit 1), _room);
      END LOOP;
    END LOOP;
  END;
$$ LANGUAGE plpgsql;
